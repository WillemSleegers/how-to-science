...
Advice is to use the maximum likelihood method if the data is generally normally distributed and to use principal axis factoring if the data is non-normal [@costello2005].
...
Alternate tests for factor retention include the scree test, Velicer's MAP criteria, and parallel analysis (Velicer & Jackson, 1990).
