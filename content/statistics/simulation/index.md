...
- [One group from descriptives](#one-group-from-descriptives)
- [Two groups from descriptives](#two-groups-from-descriptives)
- [Two groups from an effect size](#two-groups-from-an-effect-size)
- [Choosing the units](#choosing-the-units)
- [From a regression equation](#from-a-regression-equation)
