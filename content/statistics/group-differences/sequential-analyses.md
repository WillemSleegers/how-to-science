...
![Horizontal lines show the 95% interval of the estimate from the largest sample.](sequential-analyses_files/figure-commonmark/estimates-plot-2-groups-1.png)
...
![Bayes factors per sample size](sequential-analyses_files/figure-commonmark/plot-bayes-factors-2-groups-1.png)
...
![Horizontal lines show the 95% interval of the estimate from the largest sample.](sequential-analyses_files/figure-commonmark/plot-4-groups-1.png)
...
![](sequential-analyses_files/figure-commonmark/unnamed-chunk-1-1.png)
