...
```
    ...
    Intercept     -0.00      0.06    -0.12     0.12 1.00     1186     2015
    conditionB     0.10      0.09    -0.07     0.26 1.00     1705     2477
    conditionC     0.20      0.09     0.03     0.37 1.00     1616     2168
    conditionD     0.30      0.09     0.12     0.47 1.00     1636     2529
    conditionE     0.40      0.09     0.23     0.57 1.00     1697     2256

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     1.00      0.02     0.96     1.04 1.00     3490     2999
...
```
     ...
     A - B     -0.1016    -0.262    0.0717
     A - C     -0.2015    -0.364   -0.0268
     A - D     -0.3022    -0.470   -0.1260
     A - E     -0.3989    -0.573   -0.2262
     B - C     -0.1023    -0.270    0.0730
     B - D     -0.2029    -0.372   -0.0239
     B - E     -0.2989    -0.472   -0.1203
     C - D     -0.1016    -0.272    0.0869
     C - E     -0.1964    -0.361   -0.0200
     D - E     -0.0971    -0.274    0.0789
...
```
    ...
    1 (conditionB-Inter... > 0      0.1      0.14    -0.13     0.32       3.36
      Post.Prob Star
    1      0.77     
    ---
...
This gives us an estimate of 0.1 (as expected) and an evidence ratio of 3.3620502.
...
```
    ...
    Hypothesis Tests for class b:
                    Hypothesis Estimate Est.Error CI.Lower CI.Upper Evid.Ratio
    1 (conditionB-Inter... = 0      0.1      0.14    -0.18     0.36       7.72
      Post.Prob Star
    1      0.89     
    ---
    'CI': 90%-CI for one-sided and 95%-CI for two-sided hypotheses.
...
This gives us a Bayes factor of 7.715332.
...
```
    ...
    Hypothesis Tests for class b:
                    Hypothesis Estimate Est.Error CI.Lower CI.Upper Evid.Ratio
    1 (conditionD-condi... > 0      0.2      0.09     0.05     0.35      73.07
      Post.Prob Star
    1      0.99    *
    ---
    'CI': 90%-CI for one-sided and 95%-CI for two-sided hypotheses.
...
As expected, we see an estimate of 0.2 (0.4 - 0.2). We also see an evidence ratio of 73.0740741 for the hypothesis that this is larger than 0.
