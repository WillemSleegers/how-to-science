...
- [Claim 2: Every condition beats the control](#claim-2-every-condition-beats-the-control)
- [Claim 3: Which of the outcomes does the treatment affect?](#claim-3-which-of-the-outcomes-does-the-treatment-affect)
...
![False discovery rate as a function of how many of the 20 outcomes are truly identical to control, without correction and under Benjamini-Hochberg. The dashed line marks the target q = .05.](index_files/figure-commonmark/plot-which-outcomes-fdr-1.svg)
...
![Proportion of the truly affected outcomes that get flagged, under Bonferroni and Benjamini-Hochberg, as a function of how many of the 20 outcomes are truly identical to control.](index_files/figure-commonmark/plot-which-outcomes-power-1.svg)
