...
|---:|:---|---:|
| 1 | Morally, animals always count for less than humans. | 0 |
| 2 | Humans have the right to use animals however they want to. | 0 |
| 3 | It is morally acceptable to keep animals in circuses for human entertainment. | 0 |
| 4 | It is morally acceptable to trade animals like possessions. | 0 |
| 5 | Chimpanzees should have basic legal rights such as a right to life or a prohibition of torture. | 1 |
| 6 | It is morally acceptable to perform medical experiments on animals that we would not perform on any human. | 0 |

## Reference

<div id="refs" class="references csl-bib-body hanging-indent" entry-spacing="0" line-spacing="2">

<div id="ref-caviola2019" class="csl-entry">
