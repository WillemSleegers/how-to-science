...
```{r}
#| label: supplying-context-table
#| echo: false
#| message: false
read_csv("supplying-context.csv") |>
  mutate(context = str_replace_all(context, "\n", " ")) |>
  select(
    Type = type,
    Context = context,
    Text = text,
