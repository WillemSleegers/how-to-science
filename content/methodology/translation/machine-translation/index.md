...
- [Piped text](#piped-text)
  - [Does the placeholder survive translation?](#does-the-placeholder-survive-translation)
  - [Agreement with the filled-in value](#agreement-with-the-filled-in-value)
...
### Does the placeholder survive translation?
...
items |>
  mutate(
    ...
    preserved   = map2_lgl(translation, placeholders, \(out, ph) all(str_detect(out, fixed(ph))))
  ) |>
...
### Agreement with the filled-in value
...
#### A targeted prompt does not fix it
...
#### Fixing it outside the translation
