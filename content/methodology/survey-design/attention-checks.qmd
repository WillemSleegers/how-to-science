...
There are different types of checks to detect inattentive participants:
...
4.  Please write "twenty-five" using numbers. \[Text box\] [@stagnaro2024]

##### Slider

1.  Please position the slider to the number 5. \[Slider\]
